...
const TopBar = () => {
  return (
    <div className="bg-[#0d1f35] text-white py-2 sm:py-2.5 border-b border-white/10 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#c49a3c]/15 via-transparent to-[#0d1f35]/40 pointer-events-none" />
      ...
      <div className="container mx-auto px-4 lg:px-8 flex flex-col sm:flex-row justify-between items-center max-w-7xl relative z-10 gap-2 sm:gap-0">
        ...
        <div className="flex flex-row items-start sm:items-center justify-center w-full sm:w-auto text-center sm:text-left px-2 sm:px-0">
          ...
          <span className="text-gray-300 text-[9px] sm:text-[11px] tracking-wide font-medium leading-[1.6] sm:leading-tight">
            ...
            <span className="hidden sm:inline text-[#c49a3c] mx-2">•</span>
        ...
        <div className="flex items-center shrink-0 w-full sm:w-auto justify-center sm:justify-end border-t border-white/5 sm:border-none pt-2 sm:pt-0 mt-0.5 sm:mt-0">
          <a
            ...
            className="group flex items-center gap-2.5 px-6 sm:px-4 py-1.5 bg-white/5 hover:bg-[#c49a3c] border border-white/10 hover:border-[#c49a3c] rounded-full transition-all duration-300 shadow-sm"
            aria-label="LinkedIn"
          >
            {/* Mobile Pulse Indicator inside the pill */}
            <span className="relative flex h-1.5 w-1.5 shrink-0 sm:hidden">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#c49a3c] group-hover:bg-white opacity-75"></span>
              <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-[#c49a3c] group-hover:bg-white transition-colors"></span>
            </span>
            ...
            <FaLinkedinIn className="w-3.5 h-3.5 text-[#c49a3c] group-hover:text-white transition-colors" />
          </a>
        </div>
