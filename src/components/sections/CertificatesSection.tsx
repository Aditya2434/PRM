    ...
    <div className="w-full flex flex-col">
      ...
      <section className="relative bg-[#0d1f35] pt-32 pb-16 md:pt-40 md:pb-20 overflow-hidden flex items-center min-h-[55vh]">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 flex flex-col items-center justify-center text-center">
          ...
          >
            <div className="w-14 h-14 bg-[#c49a3c]/20 border border-[#c49a3c]/40 rounded-full flex items-center justify-center mb-5 backdrop-blur-md shadow-xl">
              <Award className="w-7 h-7 text-[#c49a3c]" strokeWidth={1.5} />
            </div>
            <div className="inline-flex items-center gap-2 bg-[#c49a3c]/15 border border-[#c49a3c]/30 rounded-full px-5 py-1.5 mb-5 backdrop-blur-sm">
              ...
              <span className="text-[#c49a3c] text-[10px] font-black uppercase tracking-[0.25em]">Accreditations</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 drop-shadow-lg tracking-tight">
              Our Certificates
            </h1>
            <div className="w-16 h-[3px] bg-gradient-to-r from-[#c49a3c] to-transparent mx-auto mb-5" />
            ...
            <div className="flex items-center gap-2 text-[11px] md:text-[12px] font-bold tracking-[0.2em] text-white/80 uppercase bg-black/25 px-6 py-2.5 rounded-full backdrop-blur-md border border-white/10">
              ...
              <span className="text-[#c49a3c]">Certificates</span>
            </div>
          </motion.div>
        </div>
      </section>
               ...
               <Dialog key={cert.id}>
                 ...
                 >
                   ...
                   <div className="relative overflow-hidden aspect-[4/5] bg-gray-100 p-6 flex items-center justify-center">
                     ...
                     {/* Hover Overlay */}
                     <div className="absolute inset-0 bg-[#0d1f35]/80 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center">
                       <DialogTrigger asChild>
                         <button className="bg-white text-[#c49a3c] px-8 py-3.5 rounded-full font-bold shadow-xl hover:scale-105 hover:bg-gray-50 transition-all flex items-center gap-2">
                   ...
                   <div className="p-8 text-center flex-grow flex flex-col justify-center bg-white relative">
                     ...
                     <div className="absolute top-0 left-1/2 -translate-x-1/2 w-12 h-1 bg-[#c49a3c] rounded-b-md"></div>
                     <h4 className="text-xl md:text-2xl font-bold text-[#0d1f35]">{cert.title}</h4>
                   </div>
                 </motion.div>
