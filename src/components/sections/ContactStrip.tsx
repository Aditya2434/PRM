        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {contactInfo.map((item, index) => (
            <motion.div
              ...
              className="group relative overflow-hidden flex items-center p-5 sm:p-6 lg:p-8 bg-[#0f172a] rounded-2xl shadow-xl hover:shadow-[0_8px_30px_rgb(230,57,70,0.2)] transition-all duration-300 border border-white/5"
            >
              ...
              <div className="relative z-10 flex items-center gap-4 sm:gap-5 w-full">
                ...
                <div className="shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-white/5 border border-white/10 rounded-full flex items-center justify-center group-hover:bg-[#e63946] group-hover:border-[#e63946] group-hover:scale-110 transition-all duration-300 shadow-inner">
                  <item.icon className="w-4 h-4 sm:w-5 sm:h-5 text-[#e63946] group-hover:text-white transition-colors duration-300" strokeWidth={2} />
                </div>
